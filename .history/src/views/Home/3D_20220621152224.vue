<template>
  <div class="map-box">
    ...
    <button class="btn1" style="left: 307.35px; top: 44.5px" @click="Time()">
...
import TimeIntervalCollection from "./funcs/TimeIntervalCollectionProperty.js";
